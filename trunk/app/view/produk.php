<div id="produk">
	...
	<div id="PRODUK ATASBAJU.COM">
		DAFTAR AKUN
	</div>

	<div id="boxes">
		<ul>
			<li id="d_akun" class="box"><p>Tambah Produk Baru</p></li>
			<li id="d_perusahaan" class="box"><p>Manajemen Keuangan</p></li>
			<li id="selesai" class="box"><p>Manajemen Kegiatan</p></li>
		</ul>
	</div>
